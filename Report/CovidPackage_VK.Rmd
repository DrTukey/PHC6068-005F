...
Historic COVID cases can be plotted using the function covid_cases_graph. 

```{r}
covid_cases_graph("2020-06-30", "2020-11-30",  per100k = TRUE)
```

Historic COVID deaths can be plotted using the function covid_deaths_graph.

```{r}
covid_deaths_graph("2020-06-30", "2020-11-30",  per100k = TRUE)
```
